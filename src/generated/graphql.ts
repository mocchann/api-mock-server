...
export type GetUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, name: string, email: string, posts: Array<{ __typename?: 'Post', id: string, title: string, content: string, createdAt: string }> }> };
